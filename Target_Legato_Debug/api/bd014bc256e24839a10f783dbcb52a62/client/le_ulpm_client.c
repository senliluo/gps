...
)
{
    ...
    _msgBufPtr = PackData( _msgBufPtr, &state, sizeof(le_ulpm_GpioState_t) );
...
)
{
    ...
    // Pack the input parameters
    _msgBufPtr = PackData( _msgBufPtr, &expiryVal, sizeof(uint32_t) );
...
)
{
    ...
    // Pack the input parameters
    _msgBufPtr = PackData( _msgBufPtr, &versionNumElements, sizeof(size_t) );
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackString( _msgBufPtr, version, versionNumElements*sizeof(char) );
