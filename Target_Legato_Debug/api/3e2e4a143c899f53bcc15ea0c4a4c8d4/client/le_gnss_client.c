...
)
{
    ...
    _msgBufPtr = PackData( _msgBufPtr, &constellationMask, sizeof(le_gnss_ConstellationBitMask_t) );
...
)
{
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, constellationMaskPtr, sizeof(le_gnss_ConstellationBitMask_t) );
...
)
{
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, startTimePtr, sizeof(uint64_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, stopTimePtr, sizeof(uint64_t) );
...
)
{
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, ttffPtr, sizeof(uint32_t) );
...
)
{
    ...
    _msgBufPtr = UnpackData( _msgBufPtr, &positionSampleRef, sizeof(le_gnss_SampleRef_t) );
...
)
{
    ...
    _UNLOCK
    addHandlerRef = (le_gnss_PositionHandlerRef_t)clientDataPtr->handlerRef;
    le_mem_Release(clientDataPtr);
    _msgBufPtr = PackData( _msgBufPtr, &addHandlerRef, sizeof(le_gnss_PositionHandlerRef_t) );
...
)
{
    ...
    // Pack the input parameters
    _msgBufPtr = PackData( _msgBufPtr, &positionSampleRef, sizeof(le_gnss_SampleRef_t) );
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, statePtr, sizeof(le_gnss_FixState_t) );
...
)
{
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, gpsWeekPtr, sizeof(uint32_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, gpsTimeOfWeekPtr, sizeof(uint32_t) );
...
)
{
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, timeAccuracyPtr, sizeof(uint32_t) );
...
)
{
    ...
    // Pack the input parameters
    _msgBufPtr = PackData( _msgBufPtr, &positionSampleRef, sizeof(le_gnss_SampleRef_t) );
    _msgBufPtr = PackData( _msgBufPtr, satIdNumElementsPtr, sizeof(size_t) );
    _msgBufPtr = PackData( _msgBufPtr, satConstNumElementsPtr, sizeof(size_t) );
    _msgBufPtr = PackData( _msgBufPtr, satUsedNumElementsPtr, sizeof(size_t) );
    _msgBufPtr = PackData( _msgBufPtr, satSnrNumElementsPtr, sizeof(size_t) );
    _msgBufPtr = PackData( _msgBufPtr, satAzimNumElementsPtr, sizeof(size_t) );
    _msgBufPtr = PackData( _msgBufPtr, satElevNumElementsPtr, sizeof(size_t) );
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, satIdNumElementsPtr, sizeof(size_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, satIdPtr, *satIdNumElementsPtr*sizeof(uint16_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, satConstNumElementsPtr, sizeof(size_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, satConstPtr, *satConstNumElementsPtr*sizeof(le_gnss_Constellation_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, satUsedNumElementsPtr, sizeof(size_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, satUsedPtr, *satUsedNumElementsPtr*sizeof(bool) );
    _msgBufPtr = UnpackData( _msgBufPtr, satSnrNumElementsPtr, sizeof(size_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, satSnrPtr, *satSnrNumElementsPtr*sizeof(uint8_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, satAzimNumElementsPtr, sizeof(size_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, satAzimPtr, *satAzimNumElementsPtr*sizeof(uint16_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, satElevNumElementsPtr, sizeof(size_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, satElevPtr, *satElevNumElementsPtr*sizeof(uint8_t) );
...
)
{
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, satsInViewCountPtr, sizeof(uint8_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, satsTrackingCountPtr, sizeof(uint8_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, satsUsedCountPtr, sizeof(uint8_t) );
...
)
{
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, hdopPtr, sizeof(uint16_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, vdopPtr, sizeof(uint16_t) );
    _msgBufPtr = UnpackData( _msgBufPtr, pdopPtr, sizeof(uint16_t) );
...
)
{
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, altitudeOnWgs84Ptr, sizeof(int32_t) );
...
)
{
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, magneticDeviationPtr, sizeof(int32_t) );
...
)
{
    ...
    // Pack the input parameters
    _msgBufPtr = PackData( _msgBufPtr, &assistedMode, sizeof(le_gnss_AssistedMode_t) );
...
)
{
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, assistedModePtr, sizeof(le_gnss_AssistedMode_t) );
...
)
{
    ...
    // Range check values, if appropriate
    if ( strlen(suplServerUrl) > 256 ) LE_FATAL("strlen(suplServerUrl) > 256");
    ...
    // Pack the input parameters
    _msgBufPtr = PackString( _msgBufPtr, suplServerUrl );
...
)
{
    ...
    // Range check values, if appropriate
    if ( strlen(suplCertificate) > 2000 ) LE_FATAL("strlen(suplCertificate) > 2000");
    ...
    // Pack the input parameters
    _msgBufPtr = PackData( _msgBufPtr, &suplCertificateId, sizeof(uint8_t) );
    _msgBufPtr = PackData( _msgBufPtr, &suplCertificateLen, sizeof(uint16_t) );
    _msgBufPtr = PackString( _msgBufPtr, suplCertificate );
...
)
{
    ...
    // Pack the input parameters
    _msgBufPtr = PackData( _msgBufPtr, &nmeaMask, sizeof(le_gnss_NmeaBitMask_t) );
...
)
{
    ...
    // Unpack any "out" parameters
    _msgBufPtr = UnpackData( _msgBufPtr, nmeaMaskPtrPtr, sizeof(le_gnss_NmeaBitMask_t) );
